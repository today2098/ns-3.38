...
TypeHeader::GetTypeId() {
    static TypeId tid = TypeId("ns3::myaodv::TypeHeader")
                            .SetParent<Header>()
                            .SetGroupName("MyAodv")
...
bool TypeHeader::operator==(const TypeHeader& o) const {
...
RreqHeader::GetTypeId() {
    static TypeId tid = TypeId("ns3::myaodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
void RreqHeader::SetGratuitousRrep(bool f) {
    if(f) {
        m_flags |= (1 << 5);
    } else {
        m_flags &= ~(1 << 5);
...
bool RreqHeader::GetGratuitousRrep() const {
    return (m_flags & (1 << 5));
}
...
bool RreqHeader::operator==(const RreqHeader& o) const {
...
RrepHeader::GetTypeId() {
    static TypeId tid = TypeId("ns3::myaodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
bool RrepHeader::operator==(const RrepHeader& o) const {
...
void RrepHeader::SetHello(Ipv4Address origin, uint32_t srcSeqNo, Time lifetime) {
    m_flags = 0;
    m_prefixSize = 0;
    m_hopCount = 0;
    m_dst = origin;
...
RrepAckHeader::GetTypeId() {
    static TypeId tid = TypeId("ns3::myaodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
bool RrepAckHeader::operator==(const RrepAckHeader& o) const {
...
RerrHeader::GetTypeId() {
    static TypeId tid = TypeId("ns3::myaodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Aodv")
...
bool RerrHeader::operator==(const RerrHeader& o) const {
